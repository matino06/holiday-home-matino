            ...
            <div className='col-1-of-2'>
                <div className='footer__navigation'>
                    <ul>
                        ...
                        <li className='footer__item'><a className='footer__link' href='http://localhost:3000/gallery'>Gallery</a></li>
                        <li className='footer__item'><a className='footer__link' href='http://localhost:3000/contact-us'>Contact us</a></li>
                    </ul>
                </div>
            </div>
            <div className='col-1-of-2'>
